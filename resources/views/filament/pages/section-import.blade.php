<x-filament-panels::page>
    <div class="card">
        ...
        <div class="mt-3">
            <span>Contoh : </span>
            <table class="bordered-table" style="width: 80%;">
                <thead>
                    <tr>
                        <th><div class="text-left">name</div></th>
                        <th><div class="text-left">departement</div></th>
    ...
    <div class="">
        <x-filament::button wire:click="importSection" style="margin-right: 5px;">
            Import
        </x-filament::button>
