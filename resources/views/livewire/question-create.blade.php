<div class="bg-gray-100 p-8 h-screen">
    <div x-data="{
        show_toast: @entangle('error_toast')
    }">
        <div x-cloak x-show="show_toast" class="fixed top-4 right-4 space-y-4">
            <div id="toast-danger" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
                ...
                <div class="ms-3 text-sm font-normal">Something wrong. Please try again or contact IT.</div>
    ...
    <div class="block lg:w-1/2 p-6 bg-white border border-gray-200 rounded-lg shadow mb-4">
        <h5 class="mb-2 text-3xl font-bold tracking-tight text-gray-900">Create Tiki Question</h5>
        <div class="mt-5">
            <form wire:submit="create">
                ...
                <div class="flex justify-between items-center mt-5">
                    <div>
                        <span>This field <sup class="text-red-600 font-medium">*</sup> is required.</span>
                    </div>
                    <div class="inline-flex gap-1 rounded-md shadow-sm" role="group">
                        <a href="{{route('question')}}">
                            <button type="button" class="inline-flex gap-1 items-center px-4 py-2 text-sm font-medium text-gray-900 bg-gray-100 border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10">
                                Back
                              </button>
                        </a>
